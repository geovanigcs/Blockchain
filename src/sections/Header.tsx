            ...
            <div className="container">
                <div className="flex justify-between items-center h-24 md:h-28">
                    ...
                    <div className="flex gap-4 items-center">
                        <button className="bg-fuchsia-500/20 px-4 py-2 relative font-extrabold uppercase font-heading text-sm tracking-wide hidden md:inline-flex">
                            ...
                            <span className="leading-6">Get Started</span></button>
